...
[bg storage=start.jpg width=1280 height=720 time=500]
[position left=0 top=480 width=1280 height=300 visible=true]
今日は待ちに待った矢上祭。[l][r]
うきうきで大階段を登ると、知らない声に呼び止められた。[l][r]
「あの…お願いがあって……」[l][r]
「"やがぽん"を探して欲しいのです。」[l][r]
[r]
"やがぽん"というのは矢上祭の精霊である。[l][r]
どうやら、1枚の紙切れを残してどこかに行ってしまったらしい。[l][r]
「これなんですけど…」[l][r][cm]
[chara_new name="nazo1" storage="nazo/nazo1.png"]
[chara_show name="nazo1" width=500 top = 50 layer="1"]
これは…謎解き？[l][r]
謎解きが大好きな私はやがぽん探しに協力することにした。[l][r]
「どうか今日中に連れ帰ってきてください。」[l][r]
そう約束をかわし、私は矢上祭へと足を進めた。[l][r]
[freeimage layer="1" time="500"]
[jump target=*map]
...
どっちがいいかな…？[l][r]
[link target=*yakisoba] → 焼きそば　　 [endlink]
...
[link target=*b2] → 11~14　　 [endlink]
[link target=*21] → 21 [endlink][r]
[link target=*22] → 22　　　　 [endlink]
